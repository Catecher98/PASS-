...
from PASS_grad import protoAugSSL
# from PASS import protoAugSSL
from ResNet_CN import resnet18_cbam # using the ResNet-CN as backbone
...
def arg_parse():
    ...
    parser.add_argument('--exp', default='1', type=int, help='the number of experiment')
...
def main():
    ...
    file_name = args.data_name + '_fg' + str(args.fg_nc) + '_' + str(args.task_num) + 'multi' + str(task_size) + '_exp' + str(args.exp)
